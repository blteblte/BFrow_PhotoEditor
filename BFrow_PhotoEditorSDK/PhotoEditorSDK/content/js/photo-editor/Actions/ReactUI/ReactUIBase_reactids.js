    ...
    (function (Actions) {
        ...
        (function (ReactUI) {
            var ReactUIBase_reactids = (function (_super) {
                ...
                ReactUIBase_reactids.prototype._createSubControls = function (buttonControls, $target) {
                ...
                ReactUIBase_reactids.prototype._disposeSubControls = function () {
                    $("#" + this.containerId + " .main-controls-button").show();
                    $("#" + this.containerId + " .photo-editor-ui_sub-controls-container").remove();
                };
                ReactUIBase_reactids.prototype._launchControl = function (operation, intitSelector) {
                    var _this = this;
                ...
                * @return {string}
                */
                ReactUIBase_reactids.prototype._findControl = function (control) {
                    var selector;
                ...
                * @return {string}
                */
                ReactUIBase_reactids.prototype.getFilterImageByName = function (filterName) {
                ...
                return ReactUIBase_reactids;
            })(Actions.SDK.BasicActions);
            ReactUI.ReactUIBase_reactids = ReactUIBase_reactids;
